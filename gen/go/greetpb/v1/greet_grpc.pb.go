...
func (c *greetServiceClient) Greet(ctx context.Context, in *GreetRequest, opts ...grpc.CallOption) (*GreetResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/greetpb.v1.GreetService/Greet", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *greetServiceClient) GreetManyTimes(ctx context.Context, in *GreetManyTimesRequest, opts ...grpc.CallOption) (GreetService_GreetManyTimesClient, error) {
	stream, err := c.cc.NewStream(ctx, &GreetService_ServiceDesc.Streams[0], "/greetpb.v1.GreetService/GreetManyTimes", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *greetServiceClient) LongGreet(ctx context.Context, opts ...grpc.CallOption) (GreetService_LongGreetClient, error) {
	stream, err := c.cc.NewStream(ctx, &GreetService_ServiceDesc.Streams[1], "/greetpb.v1.GreetService/LongGreet", opts...)
	if err != nil {
		return nil, err
	}
...
func _GreetService_Greet_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/greetpb.v1.GreetService/Greet",
	}
...
var GreetService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "greetpb.v1.GreetService",
	...
	Metadata: "greetpb/v1/greet.proto",
}
